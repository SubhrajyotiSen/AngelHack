...
namespace TweetJam.Pages
{
    public sealed partial class ShellPage : Page
    {
        ...
        private void InitializeNavigationItems()
        {
            ...
            NavigationItems.Add(AppNavigation.NodeFromAction(
				"328c2134-d031-46f6-b728-88cab19c8934",
                "Traffic",                
                AppNavigation.ActionFromPage("TrafficListPage"),
				AppNavigation.IconFromGlyph("\ue134")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"a64f8717-7eb3-4b2f-9e73-64dcd6dce97f",
                "Bangalore",                
                AppNavigation.ActionFromPage("BangaloreListPage"),
				AppNavigation.IconFromGlyph("\ue134")));
